...
{
    public partial class Pegawai : System.Web.UI.Page
    {
        ...
        //{
        //    con.Open();
        //    SqlCommand comm = new SqlCommand("Update Pegawai where id_pegawai set Judul_buku='" + TextBox2.Text + "',Jenis_buku='" + DropDownList1.Text + "',jumlah_buku='" + TextBox3.Text + "',harga='" + TextBox4.Text + "'", con);
        ...
        {
            con.Open();
            SqlCommand comm = new SqlCommand("Delete Pegawai where id_pegawai='" + TextBox1.Text + "'", con);
            comm.ExecuteNonQuery();
            con.Close();
